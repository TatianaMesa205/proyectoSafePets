...
<head>
  ...
  <link rel="stylesheet" href="view/css/styles.css"> </head>
<body>
...
<section class="about" style="margin-top: 30px;">
    ...
    <div class="about-text">
      ...
      <a href="login" class="btn btn-primary d-block mx-auto mt-3" style="background: #c4a484; border: none; max-width: 200px;">Iniciar Sesión</a>
    </div>
</section>
